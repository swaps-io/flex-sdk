...
const paths = [
  ...
  'facets/views/FlexSendStateFacet.sol',
  ...
  'libraries/constraints/FlexSendStateConstraint.sol',
  ...
  'interfaces/enums/FlexSendState.sol',
  ...
  'interfaces/views/IFlexSendState.sol',
