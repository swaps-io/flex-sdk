...
// external.keccak256("FlexReceive(bytes32)")
...
// external.keccak256("FlexConfirm(bytes32)")
...
// external.keccak256("FlexRefund(bytes32)")
...
// external.keccak256("FlexSend(bytes32)")
...
// external.keccak256("FlexSendAmount(bytes32,uint256)")
...
// external.keccak256("FlexSendSave(bytes32,bytes32,bytes32)")
...
// external.keccak256("FlexSendFail(bytes32)")
